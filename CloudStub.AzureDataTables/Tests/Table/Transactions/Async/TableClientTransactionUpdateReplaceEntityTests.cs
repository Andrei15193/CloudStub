...
namespace CloudStub.AzureDataTables.Tests.Table.Transactions.Async
{
    public class TableClientTransactionUpdateReplaceEntityTests : BaseTableCloudStubTests
    {
        ...
        [Fact]
        public async Task SubmitTransactionAsync_WhenETagIsMissing_ReplacesEntity()
        {
            var guid = Guid.NewGuid();
            await CloudTable.CreateAsync();
            await CloudTable.AddEntityAsync(new TestEntity
            {
        ...
        [Fact]
        public async Task SubmitTransactionAsync_WhenETagsIsWildcard_ReplacesEntity()
        {
            var guid = Guid.NewGuid();
            await CloudTable.CreateAsync();
            await CloudTable.AddEntityAsync(new TestEntity
        ...
        [Fact]
        public async Task SubmitTransactionAsync_WhenETagsMatch_ReplacesEntity()
        {
            var guid = Guid.NewGuid();
            await CloudTable.CreateAsync();
            var addResult = await CloudTable.AddEntityAsync(new TestEntity
            {
                PartitionKey = "partition-key",
                RowKey = "row-key",
                Int32Prop = 14,
        ...
        [Fact]
        public async Task SubmitTransactionAsync_WhenEntityDoesNotExistWithDefaultEtag_InsertsEntity()
        {
            await CloudTable.CreateAsync();
        ...
        [Fact]
        public async Task SubmitTransactionAsync_WhenEntityDoesNotExistAndEtagIsWildcard_InsertsEntity()
        {
            await CloudTable.CreateAsync();
        ...
        [Fact]
        public async Task SubmitTransactionAsync_WhenMultipleEntitiesDoNotExistAndEtagIsWildcard_InsertsEntity()
        {
            await CloudTable.CreateAsync();
        ...
        public async Task SubmitTransactionAsync_WhenETagsMismatch_ThrowsException()
        {
            ...
            await CloudTable.UpdateEntityAsync(new TableEntity { PartitionKey = "partition-key", RowKey = "row-key" }, addResult.Headers.ETag.Value, TableUpdateMode.Replace);
        ...
        {
            await CloudTable.CreateAsync();
            await CloudTable.AddEntityAsync(new TestEntity { PartitionKey = "partition-key", RowKey = "row-key" });
