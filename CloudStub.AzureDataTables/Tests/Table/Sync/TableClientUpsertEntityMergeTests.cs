...
namespace CloudStub.AzureDataTables.Tests.Table.Sync
{
    public class TableClientUpsertEntityMergeTests : BaseTableCloudStubTests
    {
        ...
        [Fact]
        public void UpsertEntityMerge_WhenEntityDoesNotExist_InsertsEntity()
        {
        ...
        [Fact]
        public void UpsertEntityMerge_WhenEntityHasOtherProperties_InsertsEntity()
        {
        ...
        [Fact]
        public void UpsertEntityMerge_WhenEntityExists_MergesEntities()
        {
            var testEntity = new TestEntity
            {
                PartitionKey = "partition-key",
        ...
        public void UpsertEntityMerge_WhenPartitionKeyIsInvalid_ThrowsException(string partitionKey)
        {
        ...
        [Theory, MemberData(nameof(TableOperationTestData.InvalidKeyTestData), MemberType = typeof(TableOperationTestData))]
        public void UpsertEntityMerge_WhenRowKeyIsInvalid_ThrowsException(string rowKey)
        {
            var testEntity = new TestEntity
            {
                PartitionKey = "partition-key",
